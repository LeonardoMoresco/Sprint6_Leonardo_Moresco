...
Funcionalidade: Cadastro de administrador
    ...
    Cenário: Cadastro administrador realizado com sucesso
    Quando o usuário preencher os campos de dados "<Digite seu nome>" e "<Digite sua senha>"
        Então deverá ser exibida a "<msg>"
        Exemplos:
        |Digite seu nome |Digite sua senha |msg                               |
        |Leonardo        |Teste@123        |Cadastro realizado com sucesso    |
